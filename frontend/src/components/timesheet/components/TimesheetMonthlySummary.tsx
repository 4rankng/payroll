  ...
  return (
    <div className="bg-emerald-50 rounded-xl p-4">
      ...
      <div className="grid grid-cols-2 gap-3 typography-body-medium">
        <div>
          <span className="typography-body-small text-emerald-700">Tổng giờ</span>
          <p className="font-medium">{totalHours} giờ</p>
        </div>
        <div>
          <span className="typography-body-small text-emerald-700">Tổng tiền</span>
        ...
        <div>
          <span className="typography-body-small text-emerald-700">Ngày làm</span>
          <p className="font-medium">{summaryData.workingDays} ngày</p>
        </div>
        <div>
          <span className="typography-body-small text-emerald-700">TB/ngày</span>
