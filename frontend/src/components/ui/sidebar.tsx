...
/** Null-safe variant: returns null outside a SidebarProvider (tests, isolated
 * component previews) instead of throwing. Components that merely want to
 * offer a toggle when the sidebar exists should use this. */
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "min-h-10 w-full bg-background shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring",
        className
      )}
      {...props}
    />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-6 shrink-0 items-center rounded-md px-3 text-xs font-semibold uppercase tracking-widest text-sidebar-foreground/40 outline-none ring-sidebar-ring transition-[margin,opacity] ease-linear focus-visible:ring-2 [&>svg]:size-3 [&>svg]:shrink-0",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn("w-full typography-body-medium", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 typography-body-small tabular-nums text-sidebar-foreground select-none pointer-events-none",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        size === "md" && "typography-body-medium",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
