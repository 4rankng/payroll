...
interface Props {
  entry: DisbursementFeeScheduleEntry | null;
  isDeleting: boolean;
  onCancel: () => void;
  onConfirm: () => void;
}
...
export const DisbursementFeeDeleteDialog = ({
  entry,
  isDeleting,
  onCancel,
  onConfirm,
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="pt-2">
            Cấu hình phí giao dịch chi hộ hiệu lực từ ngày{" "}
        ...
        <div className="space-y-2 px-6 mt-4 pb-2">
          <Label htmlFor="dfs-delete-confirm" className="text-xs">
            Nhập <strong className="font-semibold">{expected}</strong> để xác
            nhận xóa
          </Label>
          <Input
            id="dfs-delete-confirm"
            value={typed}
