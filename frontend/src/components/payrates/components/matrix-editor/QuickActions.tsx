          ...
          <div className="flex flex-wrap gap-1">
            {suggestedPositions.map(pos => (
              <button
                ...
                className="min-h-11 rounded-full border border-border bg-card px-3 text-xs capitalize transition-colors hover:border-primary hover:text-primary"
              >
                {pos}
              </button>
            ))}
            ...
            <div className="flex flex-wrap gap-1">
              {suggestedHourTypes.slice(0, 8).map(hour => (
                <button
                  ...
                  className="min-h-11 rounded-full border border-border bg-card px-3 text-xs transition-colors hover:border-primary hover:text-primary"
                >
                  {hour}
                </button>
              ))}
