...
export function buildEmailPreviewDocument(html: string): string {
  ...
  const banner = `<div style="max-width:640px;margin:0 auto 16px;"><img src="${TINGTING_EMAIL_BANNER_URL}" alt="TingTing Soft" width="640" style="display:block;width:100%;max-width:640px;height:auto;border:0;border-radius:16px;"></div>`;
