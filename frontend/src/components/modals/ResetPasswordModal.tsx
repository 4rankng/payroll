      ...
      <DialogContent className="sm:max-w-md">
        ...
        <DialogFooter>
          <button
            onClick={handleClose}
            disabled={loading}
            className="inline-flex items-center gap-1.5 h-11 px-3 sm:h-8 rounded border border-border bg-card text-foreground text-sm font-medium whitespace-nowrap hover:bg-muted transition-colors disabled:opacity-50 disabled:pointer-events-none"
          >
            Đóng
          </button>
          <button
