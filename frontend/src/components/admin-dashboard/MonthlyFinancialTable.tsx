            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/40">
                  <th className="text-left px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-foreground">Tháng</th>
                  <th className="text-right px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-foreground">Chi phí</th>
                  <th className="text-right px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-foreground">Doanh thu</th>
                  <th className="text-right px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-foreground">Lợi nhuận</th>
                </tr>
              </thead>
