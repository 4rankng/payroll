    ...
    <div className="border rounded-xl overflow-hidden">
      ...
      {expanded && (
        <div className="border-t bg-muted/20 px-3 py-2.5 grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
          <div>
            <p className="text-[10px] text-muted-foreground font-medium mb-0.5">Loại công</p>
            <p className="text-xs">{formatPaytype(entry.paytype)}</p>
          </div>
          <div>
            <p className="text-[10px] text-muted-foreground font-medium mb-0.5">Ca làm việc</p>
            <p className="text-xs">{entry.hours_worked} giờ</p>
          </div>
          <div>
            <p className="text-[10px] text-muted-foreground font-medium mb-0.5">Đơn giá</p>
            <p className="text-xs">{formatCurrency(entry.payrate)}</p>
          </div>
          <div>
            <p className="text-[10px] text-muted-foreground font-medium mb-0.5">Đã thanh toán</p>
          ...
          {entry.paid_at && (
            <div className="col-span-2">
              <p className="text-[10px] text-muted-foreground font-medium mb-0.5">Ngày thanh toán</p>
