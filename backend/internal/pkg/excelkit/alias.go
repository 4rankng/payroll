...
//
// Keys are matched with the union of the two in-repo resolution idioms, in
// priority order:
//  1. whole cell, trimmed + lowercased (wallet-bulk style single-line headers)
//  2. each newline-separated segment, trimmed + lowercased (bilingual
//     multi-line headers like "STT\n(Ord. No.)")
//  3. whole cell with internal whitespace collapsed (OnePay style)
//  4. collapse of the diacritic-free form (OnePay unicode retry — Vietnamese
