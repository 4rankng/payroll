...
const (
	...
	MsgCannotUpdatePayrateInvalidDateVN      = "Không thể cập nhật mức lương: ngày hiệu lực phải sau ngày trả lương gần nhất"
	...
	MsgCannotProcessPayrateInvalidDateVN     = "Không thể xử lý mức lương: ngày hiệu lực phải sau ngày trả lương gần nhất"
