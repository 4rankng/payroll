...
const (
	...
	MsgPayrateDuplicateEffectiveDateVN          = "Không thể lưu mức lương: đã tồn tại cấu hình có cùng ngày hiệu lực"
	MsgPayrateMultipleOpenConfigurationsVN      = "Không thể lưu mức lương: dự án chỉ có thể có một cấu hình đang hiệu lực"
	...
	MsgCannotProcessPayrateInvalidDateVN        = "Không thể xử lý mức lương: khoảng ngày hiệu lực không hợp lệ"
