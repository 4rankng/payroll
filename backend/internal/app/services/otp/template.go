...
// intentionally table-based HTML with no external images (CSP + deliverability).
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="padding:24px;">
    <tr><td align="center">
      <table role="presentation" width="420" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;padding:32px 24px;">
        <tr><td style="padding-bottom:16px;"><img src="cid:brand-banner" alt="Ting Ting Soft" width="600" style="display:block;width:100%;max-width:600px;height:auto;border:0;"></td></tr>
