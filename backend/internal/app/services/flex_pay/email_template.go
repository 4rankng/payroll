...
func BuildSaoKeEmailBodies(forMonth, dueDate, totalCollect string) (htmlBody, textBody string) {
	htmlBody = fmt.Sprintf(`<p style="text-align:center;"><img src="https://tingting.vip/email-banner.jpg" alt="Ting Ting Soft" width="600" style="display:inline-block;width:100%%;max-width:600px;height:auto;border:0;"></p>
...
<p>Trân trọng cảm ơn Quý Công Ty đã hợp tác và tin tưởng sử dụng dịch vụ của TING TING SOFT.</p>
<p>Trân trọng,<br>TING TING SOFT - Dịch vụ Nhận lương sớm 24/7</p>`, forMonth, dueDate, totalCollect)
...
Trân trọng cảm ơn Quý Công Ty đã hợp tác và tin tưởng sử dụng dịch vụ của TING TING SOFT.

Trân trọng,
TING TING SOFT - Dịch vụ Nhận lương sớm 24/7`, forMonth, dueDate, totalCollect)
