...
func TestMaxCycleDay(t *testing.T) {
	cases := map[string]int{
		...
		"2026-02": (28 - 20 + 1) + 8, // Feb non-leap -> 18
		"2024-02": (29 - 20 + 1) + 8, // Feb leap 2024 -> 19
...
func TestCycleDayFor(t *testing.T) {
	...
	// Period "2026-06" runs June 20 -> July 8. June has 30 days -> maxCycleDay 19.
	cases := []struct {
		desc string
		t    time.Time
		want int
		...
		{"july9_sao_ke_day", time.Date(2026, 7, 9, 0, 0, 0, 0, loc), 0},
