...
func TestBuildRowsWithSwift_HappyPath(t *testing.T) {
	...
	rows, skipped, txnCodes, err := e.buildRowsWithSwift(context.Background(), data, "weekly", time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC), time.Date(2026, 7, 7, 0, 0, 0, 0, time.UTC), 1)
	if err != nil {
...
func TestBuildRowsWithSwift_BankRepoError(t *testing.T) {
	...
	rows, skipped, _, err := e.buildRowsWithSwift(context.Background(), data, "weekly", time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC), time.Date(2026, 7, 7, 0, 0, 0, 0, time.UTC), 1)
	if err != nil {
...
func TestBuildRowsWithSwift_PaymentDetailIsBareVFIC(t *testing.T) {
	...
	rows, _, _, err := e.buildRowsWithSwift(context.Background(), data, "weekly", time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC), time.Date(2026, 7, 7, 0, 0, 0, 0, time.UTC), 1)
	if err != nil {
		t.Fatalf("buildRowsWithSwift: %v", err)
	}
	if len(rows) != 1 {
