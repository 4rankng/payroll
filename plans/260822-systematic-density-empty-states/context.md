...
| Implement | PASS | Added the shared illustration, removed global heading-size inheritance, and migrated all audited standalone empty data views. Inline selector and field placeholders remain intentionally compact. |
...
- **Changed files:** `styles/base.css`, shared/table/list empty-state components, Admin/Partner page empty states, dashboard/sheet/dialog empty states, generated asset under `public/images/empty-states/`.
