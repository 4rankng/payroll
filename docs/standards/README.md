...
Cross-cutting engineering standards for the payroll project. These complement [Code Standards](../code-standards.md) (which covers naming, coding conventions, and patterns) with focused standards on review, security, performance, and UI.
...
| [UI Guidelines](ui-guidelines.md) | Design system, component, and accessibility rules |
